...
const Gorilla = () => {
  return (
    ...
    <div className=" relative justify-center items-center flex bg-varDARKWING w-screen h-screen ">
      <div className=" relative flex items-center justify-center scale-[200%]">
        <div
